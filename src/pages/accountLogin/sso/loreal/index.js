...
function decodeRsa() {
  console.log('m global', md.global)
  $.ajax({
...
function saveLocal(saveInfo) {
  ...
  setCookie(md.global.CookieKeys.LOREAL_SSO, JSON.stringify(saveInfo), expire)
  setCookie(md.global.CookieKeys.LOREAL_SSO_SOURCE, referrerValue, sourceExpire)
  setCookie(md.global.CookieKeys.LOREAL_SSO_FROM, fromSource, sourceExpire)
  // localStorage.setItem(md.global.StorageKeys.LOREAL_SSO_INFO, JSON.stringify(saveInfo))
  setTimeout(() => {
...
//   expire.setDate(expire.getDate() + 1)
//   sourceExpire.setFullYear(sourceExpire.getFullYear() + 100)
//   setCookie(md.global.CookieKeys.LOREAL_SSO, '1', expire)
//   setCookie(md.global.CookieKeys.LOREAL_SSO_SOURCE, referrerValue, sourceExpire)
//   setTimeout(() => {
//     location.href = '/app/31ec8d09-d39f-4683-8fb3-b60974963bf3/'
//   }, 100)
